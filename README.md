...
`$ react-native link react-native-img-to-pdf`
...
2. Go to `node_modules` ➜ `react-native-img-to-pdf` and add `RNImageToPdf.xcodeproj`
...
1. Open up `android/app/src/main/java/[...]/MainActivity.java`
  - Add `import com.star.RNImageToPDF.RNImageToPdfPackage;` to the imports at the top of the file
